...
/**
 * 反馈系统 - 完整抄自TalkBack Feedback
 * 
 * Pipeline架构核心：Feedback是所有操作的载体
 * 每个Feedback包含多个Part（部分），每个Part可以有不同的动作
 * 支持failover机制：如果一个动作失败，自动尝试下一个
 */
public class Feedback {
    ...
    public static Builder builder(@Nullable Performance.EventId eventId) {
        return new Builder(eventId);
    }
    
    public static Feedback create(@Nullable Performance.EventId eventId, Part... parts) {
    ...
    public static class Part {
        ...
        public static class Builder {
            ...
            public Builder(Performance.EventId eventId) {
            ...
            public Builder setSound(int resourceId, float rate, float volume) {
                this.sound = new SoundPart(resourceId, rate, volume);
                return this;
            }
            
            public Builder setVibration(int resourceId) {
                this.vibration = new VibrationPart(resourceId);
                return this;
            }
            
            public Builder setFocus(FocusPart focus) {
                this.focus = focus;
                return this;
            }
            
            public Builder setEdit(EditPart edit) {
                this.edit = edit;
                return this;
            }
            
            public Builder setGranularity(GranularityPart granularity) {
                this.granularity = granularity;
                return this;
            }
            
            public Builder setNodeAction(NodeActionPart nodeAction) {
                this.nodeAction = nodeAction;
                return this;
            }
            
            public Builder setScroll(ScrollPart scroll) {
                this.scroll = scroll;
                return this;
            }
            
            public Builder setContinuousRead(ContinuousReadPart continuousRead) {
                this.continuousRead = continuousRead;
                return this;
            }
            
            public Builder setDimScreen(DimScreenPart dimScreen) {
    ...
    public static class Builder {
        ...
        public Builder(@Nullable Performance.EventId eventId) {
            this.eventId = eventId;
        }
    ...
    public static class SpeechPart {
        ...
        public SpeechPart(Action action) {
            this.text = null;
            this.options = null;
            this.action = action;
        }
    ...
    public static class SoundPart {
        ...
        public SoundPart(int resourceId, float rate, float volume) {
    ...
    public static class VibrationPart {
        ...
        public VibrationPart(int resourceId) {
            this.resourceId = resourceId;
        }
    ...
    public static class FocusPart {
        ...
        public FocusPart(Action action, Object node) {
            this.action = action;
            this.node = node;
        }
    ...
    public static class EditPart {
        ...
        public EditPart(Action action, Object node) {
            this.action = action;
            this.node = node;
        }
    ...
    public static class GranularityPart {
        ...
        public GranularityPart(Object granularity) {
            this.granularity = granularity;
        }
    ...
    public static class NodeActionPart {
        ...
        public NodeActionPart(Object node, int actionId) {
            this.node = node;
    ...
    public static class ScrollPart {
        ...
        public ScrollPart(Object node, int action) {
            this.node = node;
            this.action = action;
        }
    ...
    public static class ContinuousReadPart {
        ...
        public ContinuousReadPart(Action action) {
            this.action = action;
        }
    ...
    public static class DimScreenPart {
        ...
        public DimScreenPart(Action action) {
            this.action = action;
        }
